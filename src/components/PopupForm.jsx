...
const PopupForm = ({
  ...
  const handleEditPin = async (e, pin) => {
    ...
    console.log("edit", editPin);
    const newEditedPin = editPin.resPin;
    console.log("new", newEditedPin);
  ...
  return (
    <>
      <div>
        <form
          onSubmit={isEdit ? (e) => handleEditPin(e, pin) : handleCreatePin}
        >
          <label>Title</label>
          <input
